...
import auto_miner.game.GameEngine;
import auto_miner.graphics.UserInterface;
import auto_miner.replay.Replay;
import auto_miner.replay.ReplayIO;
import auto_miner.strategy.*;

import javax.swing.*;

public class AutoMinerMain {
    ...
    public static void main(String[] args) {
        if (TEST_STRATEGY_WIN_PERCENT) {
            MinePlayerStrategy yourStrategy = new WorstStrategyEver(); // TODO: Replace this with your strategy
